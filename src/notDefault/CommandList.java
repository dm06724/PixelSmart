...
public class CommandList {
	...
	//After adding a command after a series of undos, the commands after the new one should be
	//deleted.
	
	//Whoever works on this, feel free to change whatever you need. This is just a template.
